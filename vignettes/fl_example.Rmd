...
# If a directory is not provided to 'dirdata' 
# a default directory will be created at "FjordLight.d"
fl_DownloadFjord(fjord, dirdata = "test_dir")
WANT_TIME_SERIES <- TRUE
fjorddata <- fl_LoadFjord(fjord, dirdata = "test_dir", TS = WANT_TIME_SERIES)
...
P02012 <- flget_climatology(fjorddata, optics = "PAR0m", period = "Yearly", year = 2012, mode = "3col")
k2012 <- flget_climatology(fjorddata, optics = "Kpar", period = "Yearly", year = 2012, mode = "3col")
head(k2012)
```

I f you want to group the "3col" data
...
# NB: This will create a rather large object in your environment, proceed with caution
mts_full <- flget_PARbottomMonthlyTS(fjorddata, mode = "3col", PLOT = FALSE)
```
...
f2012 <- flget_Pfunction(fjorddata, type = "coastal", period = "Yearly", year = 2012, mode = "2col")
str(f2012)
